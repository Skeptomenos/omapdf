...
_GTK_THEME_COLORS = (
    ...
    ("theme_unfocused_selected_fg_color", "bright_foreground"),
    ("insensitive_bg_color", "dark_background"),
    ("insensitive_fg_color", "muted"),
    ("insensitive_base_color", "background"),
    ("accent_color", "accent"),
